...
<body>
    ...
    <section id="wrapper">
        ...
        <!--<div class="login-register" style="background-color: #87ceeb;">  -->
        <!--<div class="login-register" style="background-image: linear-gradient(skyblue, yellow);">-->
        <div class="login-register" style="height:100%; background:linear-gradient(0deg, #FFFFFF 70%, #87CEEB 30%);">
